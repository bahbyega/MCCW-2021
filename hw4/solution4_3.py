...
def main_loop():
    ...
    while True:
        ...
        for f, f_name in functions:
            ...
            appr_integrals_clar = [clarify_by_runge(
                l, h_l, h, qf, f, a, b, n) for qf in quadr_formulas]
            ...
            print(tabulate(
                [(qf_name, y, err, y_l, err_l, appr_clar, err_clar) for
                    qf_name, y, err, y_l, err_l, appr_clar, err_clar in
                    zip(
                    qf_names,
                    appr_integrals, errs,
                    appr_integrals_l, errs_l,
                    appr_integrals_clar, errs_clar
                )],
